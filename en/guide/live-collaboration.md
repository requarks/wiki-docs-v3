...
tags:
  ...
  - editing
editor: markdown
dateCreated: '2026-08-14T02:15:46.497Z'
---

# Overview

Wiki.js has built-in support for editing pages in real-time with other users. See edits happen live and view the cursors from everyone in the editor.

# Requirements

- The "**Allow Collaborative Editing**" option must be turned on in the site settings (under the **Administration Area** -> **General**).
- If using a reverse proxy, ensure web sockets are allowed to go through.
...
2. **Share** the page URL with other users.
